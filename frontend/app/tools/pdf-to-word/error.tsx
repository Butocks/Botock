...
export default function PdfToWordError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("PDF to Word Tool crashed:", error);
  }, [error]);
    ...
    <div className="max-w-2xl mx-auto py-20 px-4 text-center">
      ...
      <p className="text-slate-600 dark:text-slate-400 mb-8 leading-relaxed">
        {error?.message
          ...
          : "We encountered an unexpected error while preparing the PDF conversion tool. Thanks to Botock\u0027s isolated architecture, the rest of the application remains unaffected."}
      </p>
      <button
        onClick={() => reset()}
