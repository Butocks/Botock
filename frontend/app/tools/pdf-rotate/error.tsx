...
export default function PDFRotateError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("PDF Rotate Tool error:", error);
  }, [error]);
  ...
  return (
    <div className="max-w-2xl mx-auto py-20 px-4 text-center">
      ...
      <p className="text-slate-600 dark:text-slate-400 mb-8 leading-relaxed">
        Could not rotate the pages of this PDF. Check if the document has security locks or encryption.
      </p>
      <button
        onClick={() => reset()}
