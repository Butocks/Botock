...
export default function VideoSpeedError({ error, reset }: ErrorProps) {
  useEffect(() => {
    console.error("Video Speed Tool crashed:", error);
  }, [error]);
  ...
  return (
    <div className="max-w-2xl mx-auto py-20 px-4 text-center">
      ...
      <h2 className="text-2xl font-black text-slate-900 dark:text-white mb-4">
        Video Speed Adjustment Failed
      </h2>
      <p className="text-slate-600 dark:text-slate-400 mb-8 leading-relaxed">
        An unexpected error occurred while modifying video speed. This may be caused by an unsupported video codec,
        audio stream incompatibility, or memory limitations. Thanks to Botock&apos;s isolated tool architecture,
