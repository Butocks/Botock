...
export default function PDFSplitError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("PDF Split Tool error:", error);
  }, [error]);
  ...
  return (
    <div className="max-w-2xl mx-auto py-20 px-4 text-center">
      ...
      <p className="text-slate-600 dark:text-slate-400 mb-8 leading-relaxed">
        Could not split the PDF file. Please verify that the file is not password-protected or corrupted. The rest of the platform remains safe and functional.
      </p>
      <button
        onClick={() => reset()}
