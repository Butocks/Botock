...
export default function PDFWatermarkError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("PDF Watermark Tool error:", error);
  }, [error]);
  ...
  return (
    <div className="max-w-2xl mx-auto py-20 px-4 text-center">
      ...
      <p className="text-slate-600 dark:text-slate-400 mb-8 leading-relaxed">
        Could not apply watermark to this PDF. Verify the file is not protected or corrupted. Platform remains unaffected.
      </p>
      <button
        onClick={() => reset()}
